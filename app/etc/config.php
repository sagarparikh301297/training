...
return [
    'modules' => [
        ...
        'SimpleMagento_AddBulkProduct' => 1,
        'SimpleMagento_Attribute' => 1,
        'SimpleMagento_CollapseWidget' => 1,
        'SimpleMagento_CustomAdmin' => 1,
        'SimpleMagento_CustomCronJob' => 1,
        'SimpleMagento_CustomerAttribute' => 1,
        'SimpleMagento_CustomerEmail' => 0,
        'SimpleMagento_Database' => 1,
        'SimpleMagento_FirstModule' => 1,
        'SimpleMagento_HelloWorld' => 1,
        'SimpleMagento_ProductExtension' => 1,
        'SimpleMagento_ProductPrice' => 1,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
